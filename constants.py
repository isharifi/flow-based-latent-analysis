...
WEIGHTS = {
    ...
    'GLOW': 'models/pretrained/generators/GLOW/',
    'GLOW_pt_celeba': 'models/pretrained/generators/GLOW_pytorch/celeba/trained.pkg',
    'GLOW_pt_anime': 'models/pretrained/generators/GLOW_pytorch/anime/trained.pkg'
}
